    ...
    def _system_context(self) -> str:
        ...
        if dag_step_id:
            ...
            parts.append(
                ...
                "- The step title and description above, and this step's "
                "termination condition and completion evidence, declare the work to "
                "perform, not facts about the result. If they presuppose a fact, "
                "conclusion, or solution that this step's tool results and "
                "dependency results do not support, those results decide and the "
                "presupposed content must not reach your answer; report the gap the "
                "way your own agent instructions direct and treat that report as "
                "this step done. Facts the user gave in their own messages stay "
                "usable as given.\n"
