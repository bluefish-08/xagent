        ...
        *,
        ...
        if force_final_answer:
            ...
            instruction = (
                ...
                "date when forming search queries and judging source relevance. It is "
                "the date when the turn began, so if the exact current time matters or "
                "the turn may have crossed midnight, call the get_current_time tool if "
                "it is available. Only call "
