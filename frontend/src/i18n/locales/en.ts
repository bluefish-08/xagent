...
Build when you need.`,
  ...
  kb: {
    ownership: {
      ...
      nameHeldByYou: "You already reserved this name; creating it now reuses that reservation.",
      nameHeldInTeam: "This name is already reserved in your team. Ask whoever holds it to release it, or pick another.",
      nameBelongsToTeam: "Your team holds this name, so a knowledge base created with it belongs to the team, not to you.",
      nameIsTeamKnowledgeBase: "Your team already has a knowledge base with this name.",
      nameJoinsTeamKnowledgeBase: "Your team already has a knowledge base with this name; anything you upload joins it.",
      releaseStillPending: "The previous release of this name has not finished yet. Wait a moment and try again.",
      releaseFailed: "The team reservation for this name was not released. A team admin may need to clear it.",
