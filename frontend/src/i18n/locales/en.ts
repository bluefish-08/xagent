  ...
  builds: {
    ...
    configForm: {
      ...
      tools: {
        ...
        alwaysAvailable: "Built-in tools, always available: {tools}",
        selectAll: "Select All",
        categories: {
          basic: "Basic Tools",
          webSearch: "Web Search",
        ...
        categoryDescriptions: {
          basic: "System basic capabilities: running Python/JavaScript code and shell commands, calling HTTP APIs, translating JSON fields, and asking the user questions.",
