...
Build when you need.`,
  ...
  kb: {
    ownership: {
      ...
      nameHeldByTeammate: "A teammate reserved this name. Ask them to release it, or pick another.",
    ...
    errors: {
      ...
      nameTaken: "A knowledge base with this name already exists. Choose a different name.",
