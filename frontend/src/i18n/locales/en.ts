  ...
  tools: {
    ...
    mcp: {
      ...
      dialog: {
        ...
        adminKeyConfigured: "Your admin has configured a shared key — you can connect with it directly.",
        useAdminKey: "Use the admin's key",
        manageKey: "Manage my key",
        currentlyUsingOwnKey: "Currently using your own key.",
        currentlyUsingAdminKey: "Currently using the admin's shared key.",
        configure: "Configure",
