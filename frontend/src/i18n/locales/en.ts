...
Build when you need.`,
  ...
  models: {
    ...
    form: {
      ...
      inputPricePerM: "Input price (USD / 1M tokens)",
      outputPricePerM: "Output price (USD / 1M tokens)",
      pricePlaceholder: "e.g. 1.50 (optional)",
      priceHint: "Optional. Cost per 1M tokens, used for internal-channel accounting.",
